...
<body>
    ...
    <a href="cadastro.php"><button type="submit" class="btn btn-success" style="margin-top: 30px;">Cadastrar</button>
    <a href="consulta.php"> <button type="submit" class="btn btn-primary" style="margin-top: 30px;">Consultar</button>
    </div>
    </div>
