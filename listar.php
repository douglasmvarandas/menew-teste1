    ...
    <div class="container-fluid">
        ...
        <table class="table">
            ...
            <tr>
                ...
                <td>
                    <a class="btn btn-warning btn-sm" href="editar.php?id=<?php echo $id_agenda ?>" role="button">Editar</a>
                    <a class="btn btn-danger btn-sm" href="excluir.php?id=<?php echo $id_agenda ?>" role="button">Excluir</a>
                </td>
