<?php
    ...
    $sql = mysqli_query($conn, "SELECT * FROM registros WHERE nome LIKE '%$pesquisar%' LIMIT 5");
        ...
        <div class="wrapper wrapper--w960">
            <div class="card card-4">
                <div class="card-body">
                    ...
                    <h2 class="title center-button" style="margin-top: 20px;text-align: center;">Resultado da Busca</h2>
