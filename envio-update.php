        ...
        <div class="container d-flex justify-content-center pt-4">
            <div class="row">
                <?php 
                    ...
                    $sql = "UPDATE `pessoas` SET `nome`='$nome', `telefone`='$telefone', `email`='$email', `cidade`='$cidade', `estado`='$estado', `categoria`='$categoria' WHERE id = '$id'";
                    
                    
                    if ( mysqli_query($connection, $sql) ) {
                        echo "<h1 class='display-6'>$nome foi alterado(a)!</h1>";
                    } else
                        echo "<h1 class='display-6'>Erro ao tentar alterar $nome</h1>";
