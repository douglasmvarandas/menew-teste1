        ...
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                    ...
                    <h2 class="title center-button" style="margin-top: 20px;text-align: center;">Formulário de Cadastro</h2>
                        ...
                        <div class="row row-space">
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" name="telefone" placeholder="(00) 00000-0000" name="telefone" onkeypress="mask(this, telmask);" onblur="mask(this, telmask);">
                                </div>
                            </div>
                        </div>
                        <div class="row row-space">
